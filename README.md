...
Дополнительно комбированный поиск развернут с использованием веб-фреймворка FastApi на основе веб-сервера unicorn (match_api.py), обрабатывающего get запросы со списком товаров, для которых требуется подобрать 5 наиболее похожих вариантов (match_requests).  
